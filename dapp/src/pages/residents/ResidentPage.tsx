...
import { addResident, doLogout, getResident, hasManagerPermissions, hasResidentPermissions, Profile, setCounselor, type Resident } from "../../services/Web3Service";
                                    ...
                                    <div className="row ms-3">
                                        <div className="col-md-6 mb-3">
                                            <div className="form-group">
                                                ...
                                                <div className="input-group input-group-outline">
                                                    <input className="form-control" type="tel" id="phone" value={apiResident.phone || ""} placeholder="+5545999991234" onChange={onApiResidentChange}></input>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
