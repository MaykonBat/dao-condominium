...
import { Category, editTopic, getTopic, addTopic, hasManagerPermissions, Status, closeVoting, openVoting, getVotes, vote, transfer, type Topic, type Vote, Options } from "../../services/Web3Service";
...
function TopicPage() {
    ...
    function btnVoteClick(option: Options) {
        setMessage("Connectiong to MetaMask... wait...");
                                                        ...
                                                        <div className="form-group">
                                                            ...
                                                            <div className="input-group input-group-outline">
                                                                <input className="form-control"
                                                                    type="text"
                                                                    id="voting"
                                                                    value={`${votes.length} votes (${votes.filter(v => ethers.toNumber(v.option) === Options.YES).length} YES)`}
                                                                    disabled={true}>
                                                                </input>
                                                            </div>
                                                        </div>
